...
const AttachedDocumentForm = () => {
    ...
    return (
        ...
        <div className="kt-portlet__body">
          ...
          <Typography variant="subtitle1" gutterBottom>File Types Allowed: </Typography>
          <Typography variant="body1" gutterBottom>pdf, .xlsx, .xls, .png, .doc, .docx, .jpg, .jpeg, .csv, .txt</Typography>
          </div>
        </div>
      </div>
        </>
