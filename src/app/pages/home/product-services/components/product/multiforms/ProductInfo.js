        ...
        <Container>
            <Row>
                ...
                <Col xs={2}>
                    <InputGroup className='mb-4'>
                        <FormControlLabel
                                control={<Switch name ="isAddOn" onChange={props.handleOption} checked={props.data.isAddOn} />}
                                label="Is Add On?"
                        />
                    </InputGroup>
                </Col>
                ...
                <Col xs={2}>
                    <InputGroup className='mb-4'>
                        <FormControlLabel
                                control={<Switch name ="isLead" onChange={props.handleOption} checked={props.data.isLead} />}
                                label="Is Listed?"
                        />
                    </InputGroup>
                </Col>
                ...
                <Col xs={3}>
                    <InputGroup className='mb-4'>
                        <FormControlLabel
                                control={<Switch name ="canSetAnyPrice" onChange={props.handleOption} checked={props.data.canSetAnyPrice} />}
                ...
                <Col xs={6}>
                    <InputGroup className='mb-4'>
                        <FormControlLabel
                                control={<Switch name ="showOnInvoice" onChange={props.handleOption} checked={props.data.showOnInvoice} />}
                ...
                <Col xs={6}>
                    <InputGroup className='mb-4'>
                        <FormControlLabel
                                control={<Switch name ="showOnReceipt" onChange={props.handleOption} checked={props.data.showOnReceipt} />}
