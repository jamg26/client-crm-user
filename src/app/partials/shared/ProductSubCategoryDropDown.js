...
class ProductSubCategoryDropDown extends React.Component {
    ...
    constructor(props){
        super(props);
        this.handleSelectProductSubCategory = this.handleSelectProductSubCategory.bind(this);
        this.state = {
            ProductSubCategory : [],
    ...
    render(){
        return (
            <FormControl variant="outlined" style={{width:'100%'}} >
                <InputLabel id="labelProductSubCategory" >Product Sub Category</InputLabel>
                <Select
